...
public class Debai {
	...
	public static String[] Debai3 = {
			...
			"Bài 09: Cho một dãy số nguyên bất kỳ, cho trước 1 số c. Hãy đếm có bao nhiêu số của dãy trên =c; >c; <c.\r\n" ,
			...
			"Bài 13: Nhập vào kích thước ô vuông n*n, kiểm tra 3<=n<= 8. Hiển thị ra màn hình kết quả như màn hình\r\n" }; 
		
	public static String[] Debai4 = {
			...
			"Bài 16: Cho trước 2 xâu S1, S2. Hãy xét xem xâu S1 có phải là xâu con của S2 nếu xóa bỏ vài kí tự của xâu S2 ta được xâu S1.\r\n" };
